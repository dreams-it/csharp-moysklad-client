...
{
    public interface IBuyerReturnClient
    {
        List<> SearchByDemand(List<Guid> demandIds);

        List<> SearchByPlannedDate(List<double> deliveryPlannedDates);

        List<> SearchByParameters(List<Guid> demandIds = null, List<double> deliveryPlannedDates = null,
