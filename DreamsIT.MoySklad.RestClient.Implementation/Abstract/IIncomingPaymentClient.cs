...
namespace DreamsIT.MoySklad.RestClient.Implementation.Abstract
{
    public interface IIncomingPaymentClient
    {
        ...
        ResultOrError<List<PaymentIn>> SearchByParameters(List<Guid> customerOrderIds = null, List<Guid> demandIds = null, List<Guid> invoiceOutIds = null, 
            List<Guid> purchaseReturnIds = null, List<Guid> uuids = null, List<string> updated = null, List<string> names = null, 
